...
=======
-   Then the easiest option to save your credentials is by using `store_cdse_credentials`. Simply call it with the appropriate client ID and secret as arguments. Alternatively, you can set environment variables `OAUTH_CLIENTID` and `OAUTH_SECRET`, and the function will automatically retrieve and store these values.
>>>>>>> 8c585eb881afe70481332362499b7488c7e9cf21
