...
s2_file_list <- optram_acquire_s2(aoi,
                            ...
                            remote = "scihub")
#> Error in optram_acquire_s2(aoi, from_date, to_date, output_dir = output_dir, : unused argument (remote = "scihub")
...
#> Error in optram_wetdry_coefficients(full_df, output_dir = output_dir, : unused argument (trapezoid_method = meth)
edges_df <- read.csv(file.path(output_dir, "trapezoid_edges_lin.csv"))
#> Error in file(file, "rt"): cannot open the connection
plot_vi_str_cloud(full_df,
                  edges_df = edges_df,
                  output_dir = output_dir)
#> Error in plot_vi_str_cloud(full_df, edges_df = edges_df, output_dir = output_dir): unused argument (output_dir = output_dir)
...
plot_vi_str_cloud(full_df,
                  output_dir = output_dir,
                  edges_df = edges_df)
#> Error in plot_vi_str_cloud(full_df, output_dir = output_dir, edges_df = edges_df): unused argument (output_dir = output_dir)
