...
plot_vi_str_cloud(full_df, ttl,
                  ...
                  edge_points = TRUE)
#> NULL
knitr::include_graphics("vignettes/images/trapezoid_migda9_exponential.png")
#> Error in knitr::include_graphics("vignettes/images/trapezoid_migda9_exponential.png"): Cannot find the file(s): "vignettes/images/trapezoid_migda9_exponential.png"
```
...
plot_vi_str_cloud(full_df, ttl,
                  ...
                  edge_points = TRUE)
#> NULL
knitr::include_graphics("vignettes/images/trapezoid_migda9_polynomial.png")
#> Error in knitr::include_graphics("vignettes/images/trapezoid_migda9_polynomial.png"): Cannot find the file(s): "vignettes/images/trapezoid_migda9_polynomial.png"
```
