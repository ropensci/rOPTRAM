...
vignette: >
  %\VignetteIndexEntry{Aquire_sen2}
...
This vignette provides a detailed guide on acquiring Sentinel-2 imagery using both the CDSE and the openEO platform.
...
A. When you run the `acquire_openeo()` function, it internally calls the `check_openeo()` function.
