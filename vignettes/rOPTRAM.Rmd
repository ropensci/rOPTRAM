...
If you haven't obtained the credentials, you can refer to the vignette [here](https://gitlab.com/rsl-bidr/roptram/-/blob/main/vignettes/rOPTRAM_acquiring.Rmd) where setting up OAuth is demonstrated.
