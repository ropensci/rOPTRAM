...
#> ── R CMD build ──────────────────────────────────────────────────────────────────────
#>      checking for file ‘/tmp/RtmpsGKjp8/remotes2a04b02f9b02fe/roptram-HEAD-fcd58f3171658d2544ed78f7fae50554769cacda/DESCRIPTION’ ...  ✔  checking for file ‘/tmp/RtmpsGKjp8/remotes2a04b02f9b02fe/roptram-HEAD-fcd58f3171658d2544ed78f7fae50554769cacda/DESCRIPTION’
#>   ─  preparing ‘rOPTRAM’:
#>    checking DESCRIPTION meta-information ...  ✔  checking DESCRIPTION meta-information
#>   ─  checking for LF line-endings in source and make files and shell scripts
#>   ─  checking for empty or unneeded directories
#> ─  building ‘rOPTRAM_0.0.1.000.tar.gz’
#>      
#> 
library(rOPTRAM)
ls(getNamespace('rOPTRAM'))
#>  [1] "acquire_gcloud"                 "aoi_to_name"                   
#>  [3] "calculate_str"                  "calculate_vi"                  
#>  [5] "check_aoi"                      "check_scihub_access"           
#>  [7] "optram"                         "optram_acquire_s2"             
#>  [9] "optram_calculate_soil_moisture" "optram_calculate_str"          
#> [11] "optram_landsat"                 "optram_ndvi_str"               
#> [13] "optram_prepare_other_vi_str"    "optram_safe"                   
#> [15] "optram_wetdry_coefficients"     "plot_ndvi_str_cloud"
...
to_date <- "2023-03-31"
output_dir <- here::here("inst", "extdata", "S2A", "seasonal")
...
#> Reading layer `migda_aoi' from data source 
#>   `/home/micha/R/x86_64-pc-linux-gnu-library/4.2/rOPTRAM/extdata/migda_aoi.gpkg' 
#>   using driver `GPKG'
...
|-------------:|---------:|-------------:|---------:|
|      0.131351|  2.595635|      1.058494|  4.007533|
