...
coeffs <- optram(aoi_file,
                 ...
                 SWIR_band = 11)
#> Reading layer `migda_9' from data source 
#>   `/home/micha/work/dev/roptram/inst/extdata/migda_9.gpkg' using driver `GPKG'
#> Simple feature collection with 1 feature and 3 fields
#> Geometry type: POLYGON
#> Dimension:     XYZ
#> Bounding box:  xmin: 34.58383 ymin: 31.35897 xmax: 34.58903 ymax: 31.36149
#> z_range:       zmin: 0 zmax: 0
#> Geodetic CRS:  WGS 84
#> Error in CDSE::GetArchiveImage(aoi = aoi, time_range = time_range, script = scrpt, :  
#>   status      reason                             message               code
#> 1    400 Bad Request Script contains no code to execute. RENDERER_EXCEPTION
...
knitr::include_graphics("vignettes/images/trapezoid_migda9_linear.png")
#> Error in knitr::include_graphics("vignettes/images/trapezoid_migda9_linear.png"): Cannot find the file(s): "vignettes/images/trapezoid_migda9_linear.png"
```
