...
If you haven't obtained the credentials, you can refer to the vignette [here](https://github.com/ropensci/rOPTRAM/-/blob/main/vignettes/rOPTRAM_acquiring.Rmd) where setting up OAuth is demonstrated.

Downloaded Sentinel-2 images are saved to `S2_output_dir`. For this example, outputs are saved to `tempdir()`

This example uses "polynomial" trapezoid fitted curve.
...
#> /tmp/Rtmp6tLe38/file2464c6c55cef7: TIFFReadDirectory:Sum of Photometric type-related color
...
#> Error in (function (classes, fdef, mtable) : unable to find an inherited method for function 'crs' for signature '"sfc_MULTIPOLYGON"'
...
terra::plot(SM, col = rev(viridis(25)), smooth = TRUE,
            main = "Soil moisture map")
```

![plot of chunk sm-prepare](figure/sm-prepare-1.png)
...
![plot of chunk sm-plot](images/sm-plot.png)
