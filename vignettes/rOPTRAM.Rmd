...
#>   `/home/micha/R/x86_64-pc-linux-gnu-library/4.2/rOPTRAM/extdata/lachish.gpkg' 
#>   using driver `GPKG'
...
rmse <- optram(aoi,
              ...
              SWIR_band = 11)
#> Error in Summary.factor(structure(7L, levels = c("GEOMETRY", "POINT", : 'all' not meaningful for factors
knitr::kable(rmse, caption = "Trapezoid coefficients")
#> Error in knitr::kable(rmse, caption = "Trapezoid coefficients"): object 'rmse' not found
>>>>>>> main
```
### Show trapezoid plot
