...
#> Reading layer `High' from data source `/home/micha/work/dev/roptram/inst/extdata/lachish.gpkg' using driver `GPKG'
...
plot_vi_str_cloud(full_df, edges_df, edge_points = TRUE)
```

<div class="figure">
<img src="figure/plot-1.png" alt="Trapezoid scatterplot" width="90%" />
<p class="caption">Trapezoid scatterplot</p>
</div><div class="figure">
<img src="figure/plot-2.png" alt="Trapezoid scatterplot" width="90%" />
<p class="caption">Trapezoid scatterplot</p>
</div>
