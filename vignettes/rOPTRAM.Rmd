...
#>   `/home/micha/R/x86_64-pc-linux-gnu-library/4.2/rOPTRAM/extdata/lachish.gpkg' using driver `GPKG'
...
pl <- plot_vi_str_cloud(full_df, edges_df,
                        trapezoid_method = "polynomial", edge_points = TRUE)
```
