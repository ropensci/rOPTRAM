...
Registration on Copernicus DataSpace was done in advance, and the OAuth credentials (*clientid*, and *secret*) have been saved to the user's home directory. If you haven't obtained the credentials, you can refer to the vignette [here](https://gitlab.com/rsl-bidr/roptram/-/blob/main/vignettes/rOPTRAM_acquiring.Rmd) where setting up OAuth is demonstrated.
