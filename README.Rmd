...
- type: article-journal
  ...
  title-short: The optical trapezoid model
...
That R package uses the Google Cloud infrastructure to download Sentinel-2 images. Install the Google Cloud CLI to allow acquiring images directly from Google.
